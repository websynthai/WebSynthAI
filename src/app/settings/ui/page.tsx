      ...
      <Card className="border border-gray-200">
        ...
        <CardContent className="space-y-6 pt-6">
          <div className="flex items-center justify-between">
            <div>
              <Label htmlFor="preciseMode" className="font-medium">
                Precise mode
              </Label>
              <p className="text-sm text-gray-500">
                Delivers highly accurate, detail-oriented results with minimal
                creativity.
              </p>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between">
            <div>
              <Label htmlFor="balancedMode" className="font-medium">
                Balanced mode
              </Label>
              <p className="text-sm text-gray-500">
          ...
          <div className="flex items-center justify-between">
            <div>
              <Label htmlFor="creativeMode" className="font-medium">
                Creative mode
              </Label>
              <p className="text-sm text-gray-500">
