...
export const getGenerationPrompt = (uiType: string) => {
  ...
  return `
            ...
            ${
              isTypescript
                ? 'use typescript for the code. Do not define custom interface or types. just use predefined types like string, number etc '
                : 'use javascript for the complete code'
            }
            ...
            When images are required, ${
              isImages
                ? 'check if you can genrate those images else utilize the img tag with picsum.photos as the source'
                : ''
            }.
            ...
            For icons, ${
              isIcons
                ? 'use the ionicons library eg- (<ion-icon size="large" name="logoname"></ion-icon>). ion-icon is an global html context means no need to import anything'
                : ''
            }
            ...
            The complete list of available components are - ${getComponents(
              uiType,
            )}
...
export const getModifierPromt = (
  ...
  return `
            ...
            ${
              uiType === 'shadcn-react' &&
              'Only use tailwind css variables while styling background and text colors. Also asign component border radius to radius.All tailwind css variables eg are - [background, foreground, card, card-foreground, popover, popover-foreground, primary, primary-foreground, secondary, secondary-foreground, muted, muted-foreground, accent, accent-foreground, destructive, destructive-foreground, border, input, ring, radius]'
            }
            Use ${uiType} components whenever possible.
            Go through the list of components and use them whenever necessary.
            Do not use hallucinated component names like (Flex,Box, etc) which are not available.
